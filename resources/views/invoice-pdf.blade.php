...
<table>
    <tr>
        ...
        <td class="info">
            ...
            634050 г. Томск, ул. Розы Люксембург, дом 19,
            тел/факс: (3822) 511-225
            E-mail: opp@elcopro.ru
        </td>
    </tr>
</table>
<table class="details">
...
@if ($withFooter)
    <p class="header" style="page-break-inside: avoid">
        ...
        подлежат пересмотрению, а счет должен быть перевыставлен с новыми условиями поставки. Лица США / ЕС / ЕЭЗ / Великобритании / Канады / Австралии / Японии  в процесс по исполнении заказа не вовлекаются.
    </p>
@endif
